...
input_file = "/home/romilchouhan/Downloads/pedestrains.mp4"
output_file = "/home/romilchouhan/Downloads/processed_pedestrains.mp4"
...
color = (255, 0, 0)  # color of the rectangle to be blue
success = True
im_old = None
while success:
    success, im = cap.read()
